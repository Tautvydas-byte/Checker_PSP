...
public class GameLevel {
    ...
    private CheckersBehavior checkersBehavior;
    ...
    public ArrayList<Checker> getCheckersOpponent() {
    ...
    public boolean containsPosition (ArrayList<Position> possibleMoves, Position position) //This cannot be here
    {
